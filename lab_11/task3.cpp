...
void testCompression(const string& input) {
...
int main() {
    ...
    cout << "Test with 'hello world':" << endl;
    string input1 = "hello world";
    testCompression(input1);

    // Test with a string with repeated characters
    cout << "\nTest with 'aaaaaaabbbbbbbb':" << endl;
    string input2 = "aaaaaaabbbbbbbb";
    testCompression(input2);

    // Test with a longer string (real paragraph)
    cout << "\nTest with a paragraph:" << endl;
    string input3 = "Huffman coding is a data compression algorithm that is widely used in various applications, such as file compression and data transmission.";
    testCompression(input3);
